const Messaging = (function (global) {
  ...
  ClientImpl.prototype._doConnect = function (host, port) {
    ...
    if (this.connectOptions.useSSL) { wsurl = ['wss://', host, ':', port, '/mqtt'].join(''); } else { wsurl = ['ws://', host, ':', port, '/mqtt'].join(''); }
  ...
  ClientImpl.prototype._disconnected = function (errorCode, errorText) {
    ...
    if (this.connectOptions.hosts && this.hostIndex < this.connectOptions.hosts.length - 1) {
      ...
      if (this.connected) {
        ...
        if (this.connectOptions.onFailure) { this.connectOptions.onFailure({invocationContext: this.connectOptions.invocationContext, errorCode: errorCode, errorMessage: errorText}); }
      }
    }
  };
  ...
  /**
     ...
     * <a href="/clients/java/doc/javadoc/mapTool/ibm/micro/client/mqttv3/MqttClient.html"><big>Java</big></a>,
  ...
  var Client = function (host, port, clientId) {
    ...
    if (typeof clientId !== 'string' || clientIdLength < 1 | clientIdLength > 23) { throw new Error(format(ERROR.INVALID_ARGUMENT, [clientId, 'clientId'])); }
    ...
    // add by ddy 2018/3/27
    /** ***********************star************************/
    this._getClientConnectState = function () { return client.connected; }
    /** ***********************end************************/
    ...
    this.send = function (message) {
      ...
      if (typeof message.destinationName === 'undefined') { throw new Error('Invalid parameter Message.destinationName:' + message.destinationName); }
  ...
  Client.prototype = {
    ...
    // add by ddy 2018/3/27
    /** ***********************star************************/
    get connectState () { return this._getClientConnectState(); }
    /** ***********************end************************/
  };
  ...
  /**
     ...
     * <p>
     * Other programming languages,
     * <a href="/clients/java/doc/javadoc/mapTool/ibm/micro/client/mqttv3/MqttMessage.html"><big>Java</big></a>,
